...
export const saveUserToDb = createAsyncThunk(
  ...
  async (info) => {
    const response = await axios.post(
      `https://cosnt-group-server-production.up.railway.app/user`,
      info
    );
...
export const userAdmin = createAsyncThunk("userAdmin/user", async (info) => {
  const response = await axios.put(
    `https://cosnt-group-server-production.up.railway.app/user/makeAdmin`,
    info
  );
  return response.data;
});
export const isAdmin = createAsyncThunk("isAdmin/user", async (info) => {
  const response = await axios.get(
    `https://cosnt-group-server-production.up.railway.app/user/${info.email}`
  );
  return response.data;
});

export const postIndb = createAsyncThunk("postInfo/postIndb", async (info) => {
  const response = await axios.post(
    "https://cosnt-group-server-production.up.railway.app/userPost",
    info
  );
  return response.data;
});
...
export const updateLove = createAsyncThunk(
  ...
  async (info) => {
    if (info.type === "put") {
      const response = await axios.put(
        `https://cosnt-group-server-production.up.railway.app/userPost/love`,
        info
      );
      return response.data;
    } else {
...
export const sendComment = createAsyncThunk(
  ...
  async (info) => {
    const response = await axios.put(
      `https://cosnt-group-server-production.up.railway.app/userPost/comment`,
      info
    );
    return response.data;
  }
...
export const deletePost = createAsyncThunk(
  ...
  async (info) => {
    const response = await axios.delete(
      `https://cosnt-group-server-production.up.railway.app/userPost/${info._id}`,
      { data: info }
    );
...
export const deleteComment = createAsyncThunk(
  ...
  async (info) => {
    const response = await axios.put(
      `https://cosnt-group-server-production.up.railway.app/userPost/deleteComment`,
      { data: info }
    );
...
export const myPost = createAsyncThunk("myPost/getMyPost", async (info) => {
  const response = await axios.get(
    `https://cosnt-group-server-production.up.railway.app/${info.email}/${info.type}`
  );
...
export const createGroup = createAsyncThunk(
  ...
  async (info) => {
    const response = await axios.post(
      `https://cosnt-group-server-production.up.railway.app/createGroup`,
      info
    );
    return response.data;
  }
);
export const allGroup = createAsyncThunk("data/allGroup", async (info) => {
  const response = await axios.get(
    `https://cosnt-group-server-production.up.railway.app/allGroup`,
    info
  );
  return response.data;
});
export const getGroupInfo = createAsyncThunk(
  ...
  async (info) => {
    const response = await axios.get(
      `https://cosnt-group-server-production.up.railway.app/group/${info._id}`
    );
    return response.data;
  }
);
export const addUserToGroup = createAsyncThunk(
  ...
  async (info) => {
    const response = await axios.put(
      `https://cosnt-group-server-production.up.railway.app/addUserToGroup`,
      info
    );
    return response.data;
  }
...
export const removeUserFromGroup = createAsyncThunk(
  ...
  async (info) => {
    const response = await axios.put(
      `https://cosnt-group-server-production.up.railway.app/removeUserFromGroup`,
      info
    );
    return response.data;
  }
...
export const makeGroupAdmin = createAsyncThunk(
  ...
  async (info) => {
    const response = await axios.put(
      `https://cosnt-group-server-production.up.railway.app/makeGroupAdmin`,
      info
    );
    return response.data;
  }
...
export const removeAdminOfGroup = createAsyncThunk(
  ...
  async (info) => {
    const response = await axios.put(
      `https://cosnt-group-server-production.up.railway.app/removeAdminOfGroup`,
      info
    );
    return response.data;
  }
...
export const sendRequest = createAsyncThunk(
  ...
  async (info) => {
    const response = await axios.put(
      `https://cosnt-group-server-production.up.railway.app/sendRequest`,
      info
    );
    return response.data;
  }
...
export const cancelRequest = createAsyncThunk(
  ...
  async (info) => {
    const response = await axios.put(
      `https://cosnt-group-server-production.up.railway.app/cancelRequest`,
      info
    );
    return response.data;
  }
...
export const acceptRequest = createAsyncThunk(
  ...
  async (info) => {
    const response = await axios.put(
      `https://cosnt-group-server-production.up.railway.app/acceptRequest`,
      info
    );
    return response.data;
  }
...
export const deleteGroup = createAsyncThunk(
  ...
  async (info) => {
    const response = await axios.delete(
      `https://cosnt-group-server-production.up.railway.app/deleteGroup/${info.gpId}`
    );
    return response.data;
  }
);
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(sendComment.fulfilled, (state, action) => {
        const pushData = action.payload?.postIn?.split("/")[2];
        if (pushData === "help") {
          const thatPost = state.getHelp.filter(
            (p) => p._id === action.payload.postId
          );
          thatPost[0].comments.push(action.payload);
        } else if (pushData === "announcement") {
          const thatPost = state.getAnnouncement.filter(
            (p) => p._id === action.payload.postId
          );
          thatPost[0].comments.push(action.payload);
        } else if (pushData === "discussion") {
          const thatPost = state.getDiscussion.filter(
            (p) => p._id === action.payload.postId
          );
          thatPost[0].comments.push(action.payload);
        }
      ...
      .addCase(deletePost.fulfilled, (state, action) => {
        ...
        if (pushData === "/help" && state.getHelp !== null) {
          state.getHelp = state.getHelp.filter(
            (data) => data._id !== action.payload._id
          );
        } else if (
          pushData === "/announcement" &&
          state.getAnnouncement !== null
        ) {
          state.getAnnouncement = state.getAnnouncement.filter(
            (data) => data._id !== action.payload._id
          );
        } else if (pushData === "/discussion" && state.getDiscussion !== null) {
          state.getDiscussion = state.getDiscussion.filter(
            (data) => data._id !== action.payload._id
          );
        }
      })
      ...
      .addCase(getGroupInfo.fulfilled, (state, action) => {
        state.gpInfo = action.payload;
        state.isGpAdmin = Boolean(
          state?.gpInfo?.admin.filter(
            (sAdmin) => sAdmin.email === state?.user?.email
          ).length
        );
      })
      ...
      .addCase(removeUserFromGroup.fulfilled, (state, action) => {
        state.postLoad = false;
        state.gpInfo.members = state.gpInfo.members.filter(
          (sUser) => sUser.email !== action.payload?.user?.email
        );
      })
      ...
      .addCase(removeAdminOfGroup.fulfilled, (state, action) => {
        state.postLoad = false;
        state.gpInfo.admin = state.gpInfo.admin.filter(
          (sUser) => sUser.email !== action.payload?.user?.email
        );
      })
      ...
      .addCase(sendRequest.fulfilled, (state, action) => {
        state.postLoad = false;
        state.groups
          .filter((sGroup) => sGroup._id === action.payload?.gpId)[0]
          .memberRequest.push(action.payload.user);
      })
      ...
      .addCase(cancelRequest.fulfilled, (state, action) => {
        ...
        if (action.payload.deleteRequest) {
          state.gpInfo.memberRequest = state.gpInfo.memberRequest?.filter(
            (mem) => mem.email !== action.payload.user.email
          );
        } else {
          state.groups.filter(
            (sGroup) => sGroup._id === action.payload?.gpId
          )[0].memberRequest = state.groups
            .filter((sGroup) => sGroup._id === action.payload?.gpId)[0]
            .memberRequest.filter(
              (req) => req.email !== action.payload.user.email
            );
        }
      })
