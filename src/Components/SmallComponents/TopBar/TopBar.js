            ...
            {data?.user?.email ? (
              ...
              <div>
                <Button
                  ...
                  color="secondary"
                  variant="contained"
                  sx={{ background: "rgb(0 255 232 / 20%)", mr: 1 }}
                  component={NavLink}
                >
                  LogIn
                </Button>
                <Button
                  ...
                  color="secondary"
                  variant="contained"
                  sx={{ background: "rgb(0 255 232 / 20%)" }}
                  component={NavLink}
                >
                  signUp
                </Button>
            ...
            {data.gpInfo._id && (
              ...
              >
                <Tooltip title="Announcement Tab">
                  <IconButton
                    to={`${data.gpInfo._id}/announcement`}
                    component={NavLink}
                  >
