...
const CreateGroup = () => {
  ...
  const { register, handleSubmit, reset, unregister, setValue, watch } =
    useForm();
  //handle gp type
  ...
  useEffect(() => {
    ...
    if (file.length) {
      ...
      body.set("key", "ac29d313f4b97e10c009222555f0191a");
      ...
      setValue(
        "gpPhoto",
        "https://i.ibb.co/7zshrP5/pngtree-cartoon-education-training-cram-school-image-9149.jpg"
      );
    }
  }, [watch("pic")]);
  return (
        ...
        <Grid container spacing={3}>
          <Grid item xs={12} md={4}>
            <form className="w-full" onSubmit={handleSubmit(onSubmit)}>
              <input
                className="placeholder-gray-400 rounded-sm  w-full bg-transparent border-b py-2 border-red-100 px-2"
                type="text"
                placeholder="Enter Group Name"
                {...register("gpName", { required: true })}
              />

              <h2 className="text-lg mt-5 mb-2 text-gray-300 font-bold">
                {" "}
              ...
              {watch("type") === "private" && (
                <div className="flex mt-5 flex-col">
                  <h2 className="mb-1 text-lg text-gray-300 font-bold">
                    Add Questions For Join
                  </h2>
                  ...
                  <Button
                    ...
                    sx={{
                      mt: 2,
                      background: "#0b3733",
                      "&:hover": { background: "rgba(16, 185, 129, .5)" },
                    }}
          ...
          <Grid item xs={12} md={8}>
            <div
              style={{ backgroundColor: "#0b3733" }}
              className="pb-5 rounded-xl border border-green-800"
            >
              <div className="relative">
                ...
                <div className="absolute right-0 bottom-0">
                  <label
                    htmlFor="gpImg"
                    className="border border-green-600 md:mb-4 mb-2 mr-2 md:mr-10 px-3 py-2 bg-gray-900  rounded-md flex items-center"
                  >
                    <BrushIcon></BrushIcon>Edit
                  </label>
                </div>
              </div>
                ...
                <div className="flex mt-1">
                  {watch("type") === "private" ? (
                    <h4 className=" flex items-center">
                      {" "}
                      <LockIcon fontSize="small"></LockIcon>Private Group
                    </h4>
                  ) : (
                    <h4 className=" flex items-center">
                      {" "}
                      <LockOpenIcon fontSize="small"></LockOpenIcon>Public Group
                    </h4>
                  )}
